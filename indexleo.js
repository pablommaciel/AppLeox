...
const connection = mysql.createConnection({
  ...
  user: 'u625977176_RoletaLeonardo',
  password: 'Ppp135198000',
  database: 'u625977176_RoletaLeonardo',
...
setInterval(() => {
  ...
  connection.query('SELECT * FROM megaroleta ORDER BY ID DESC LIMIT 1', (err, rows) => {
    if(err) {
...
app.listen(3004, () => {
  console.log('App ouvindo na porta 3004');
});